...
(** We represent CFGs in adjacency-list format, 
    ...
    Also, note that for this example we've updated 
    the Symtab module slightly, to use integer rather 
    than string keys. *)
...
type dominators = (node list) Symtab.t
